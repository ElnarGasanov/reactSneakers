import sneakerLogo from "./img/sneakers-logo.png"
import buttonPlus from "./img/plus.svg"
import imgSneaker from "./img/imageSneaker.jpg"
        ...
        <div className="wrapper clear">
            <header className="d-flex justify-between align-center p-40">
                <div className="headerLeft d-flex align-center">
                    <img width={40} height={40} src={sneakerLogo} alt="image"/>
                ...
                <div>
                    <ul className="headerRight d-flex">
                        <li className="mr-30">
                            <svg className="mr-15" width="20" height="20" viewBox="0 0 20 20" fill="none"
            ...
            <div className="content p-40">
                ...
                <div className="d-flex">
                    <div className="card">
                        <img width={133} height={112} src={imgSneaker} alt="sneaker"/>
                        ...
                        <div className="d-flex justify-between align-center">
                            ...
                            <button className="cardButton">
                                <img width={11} height={11} src={buttonPlus} alt="button"/>
                            </button>
                        </div>
                    </div>
                    <div className="card">
